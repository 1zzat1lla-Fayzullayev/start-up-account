...
function AdminPanel() {
	...
	const openEditModal = product => {
		...
		// Set input values to the values of the selected product
		setInputValues({
				...
				<>
					...
					<div className='bg-gray-900 w-full md:w-[300px] md:h-screen p-6'>
						<div className='flex justify-center items-center flex-col'>
							<div className='flex gap-6 items-center text-3xl cursor-pointer uppercase font-bold my-8 font-Itim'>
								<h1>bee</h1>
